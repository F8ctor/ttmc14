...
reagent-desc-mc-paracetamol = Вероятно, многие знают это как Тайленол, но это не совсем так, это слабое химическое вещество и простое обезболивающее.
...
reagent-name-mc-tylenol = Тайленол
reagent-desc-mc-tylenol = Старый вариант парацетамола, может вызывать аутизм среди многих гумманоидов, чаще всего выбрасывают и не принимают в медицинских целях.
reagent-name-mc-ibuprofen = Ибупрофен
reagent-desc-mc-ibuprofen = Лекарственное средство, нестероидный противовоспалительный препарат из группы производных пропионовой кислоты, обладающий болеутоляющим и жаропонижающим действием.
# T2
